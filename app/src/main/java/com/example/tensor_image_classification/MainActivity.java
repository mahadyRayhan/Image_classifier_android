package com.example.tensor_image_classification;
...
import com.example.tensor_image_classification.classifier.ImageClassifier;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView predict_declarationTV;
    ...
    private void initializeUIElements() {
        imageLinearLayout = findViewById(R.id.image_linear_layout);
        imageView = findViewById(R.id.iv_capture);
        listView = findViewById(R.id.lv_probabilities);
        predict_declarationTV = findViewById(R.id.predict_declaration);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQEUST_CODE) {
            ...
            LinearLayout.LayoutParams params_image_linear = (LinearLayout.LayoutParams)
                    imageView.getLayoutParams();
            params_image_linear.weight = 15.0f;
            params_image_linear.width = LinearLayout.LayoutParams.MATCH_PARENT;
            imageView.setLayoutParams(params_image_linear);

            LinearLayout.LayoutParams params_textview = (LinearLayout.LayoutParams)
                    predict_declarationTV.getLayoutParams();
            params_textview.weight = 1.0f;
            predict_declarationTV.setLayoutParams(params_textview);

            LinearLayout.LayoutParams params_listview = (LinearLayout.LayoutParams)
                    listView.getLayoutParams();
            params_listview.weight = 2.0f;
